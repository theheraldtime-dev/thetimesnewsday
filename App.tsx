      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-40 shadow-[0_4px_30px_rgba(0,0,0,0.03)] perspective-1000">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="relative">
            <nav className="flex items-center justify-start md:justify-center gap-4 md:gap-8 pb-4 overflow-x-auto no-scrollbar mask-fade-edges">
              <button 
                onClick={() => setActiveCategory('All')}
                className={`text-[10px] font-black tracking-[0.2em] uppercase px-4 py-2 transition-all whitespace-nowrap preserve-3d shadow-sm hover:shadow-md ${activeCategory === 'All' ? 'bg-slate-900 text-white translate-z-10' : 'text-slate-500 hover:text-slate-900 bg-white border border-slate-200'}`}
              >
                Latest
              </button>
              {CATEGORIES.map(cat => (
                <button 
                  ...
                  className={`text-[10px] font-black tracking-[0.2em] uppercase px-4 py-2 transition-all whitespace-nowrap preserve-3d shadow-sm hover:shadow-md ${activeCategory === cat ? 'bg-blue-700 text-white translate-z-10' : 'text-slate-500 hover:text-slate-900 bg-white border border-slate-200'}`}
                >
                  {cat}
                </button>
              ))}
